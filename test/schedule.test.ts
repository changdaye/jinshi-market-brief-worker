...
describe("isDigestQuietHours", () => {
  it("treats 22:00-07:59 Asia/Shanghai as quiet hours", () => {
    expect(isDigestQuietHours(new Date("2026-04-24T14:30:00Z"))).toBe(true);
    expect(isDigestQuietHours(new Date("2026-04-23T23:30:00Z"))).toBe(true);
    expect(isDigestQuietHours(new Date("2026-04-24T00:00:00Z"))).toBe(false);
  });
